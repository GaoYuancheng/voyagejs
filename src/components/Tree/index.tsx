import { Tree as ATree, Empty, Input, Spin } from 'antd';
import type { SearchProps } from 'antd/lib/input';
import type { DataNode as ADataNode, TreeProps as ATreeProps } from 'antd/lib/tree';
...
const getParentKey = (key: string, tree: DataNode[]) => {
...
export const Tree: React.FC<TreeProps> = (props) => {
  ...
  const prefix = usePrefixCls('custom-tree');
  ...
  const onSearch: React.ChangeEventHandler<HTMLInputElement> = useCallback(
    (e) => {
      ...
      setExpandedKeys(expKeys as string[]);
